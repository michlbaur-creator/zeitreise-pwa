...
export const episodeThreeScenes: EpisodeThreeScene[] = [
  ...
  { id: 2, title: "Leben ohne Acker", timeLabel: "Etwa 12.000 bis 10.000 v. Chr.", focusLabel: "Sammeln & Jagen", speakerText: episodeThreeSpeakerTexts[2], discoveries: episodeThreeDiscoveries[2], quiz: [episodeThreeQuizzes[2][0], episodeThreeQuizzes[2][3]], imageStatus: "ready" },
  ...
  { id: 18, title: "Ein Blatt macht Karriere", timeLabel: "Über viele Jahrhunderte bis ins späte Mittelalter", focusLabel: "Papier & Ziffern", speakerText: episodeThreeSpeakerTexts[18], discoveries: episodeThreeDiscoveries[18], quiz: [episodeThreeQuizzes[18][0], episodeThreeQuizzes[18][1]], imageStatus: "ready" },
